...
def write_adas_E2E(exp_info_list):
    ...
    with open(f'{e2e_file_name}.csv', 'w') as f:
        writer = csv.writer(f)
        writer.writerow(['adas_budget', 'avg_E2E', '99percentile_E2E', 'is_collapsed', 'it0_99percentile_E2E', 'version'])

        for exp_info in exp_info_list:
            writer.writerow([7000, exp_info['adas_avg_E2E'], exp_info['adas_99percentile_E2E'], exp_info['is_collapsed'], exp_info['it0_99percentile_E2E'], exp_info['version']])
